			...
			<?php if($race_id == 6) : ?> 
			    ...
			    <?php
					switch($race_id){
						...
						break;
						case 8:  //harta
							echo '<p>Na tento závod je možné přihlásit se pouze <a style="text-decoration: underline" href="https://timechip.cz/registrace/slezska-harta-bike-maraton/2023/8">ZDE.</a></p>';
						break;
						case 5:  //welzl
