...
<div class="form-group"> 
    <select name="id_kategorie" id="vyber_kategorie_ecc" class="form-control required placeholder">
...
<div class="form-group">
    <select name="ids" id="ids" class="form-control required placeholder">
        <option value="" selected disabled>Výběr startovniho cisla podle vybrané kategorie</option>
    </select>
</div>
