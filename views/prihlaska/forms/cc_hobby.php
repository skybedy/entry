...
<!--<div class="alert alert-success" role="primary">Přihláška platí pro sobotní i nedělní závod.</div>-->
<hr>
<div class="alert alert-danger" role="alert">Před vyplněním formuláře si ještě jednou ujasněte, že se chcete opravdu přihlásit do závodů Hobby a ne do závodů MČR, nebo Poháru CAMS.</div>
<div class="alert alert-danger" role="alert">Vyplněním a odesláním přihlášky se k ničemu nezavazujete, nicméně je oboustraně výhodné, protože vy už <b>nebudete muset</b> na přejímkách nic vypisovat a nám ulehčíte práci.</div>
