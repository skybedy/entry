...
<div class="form-group"> 
	...
	<option value="4" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 4) ? ('selected="selected"') : ('')) ?>>Předžáci, předžákyně (2012-2016)</option>
	<option value="5" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 5) ? ('selected="selected"') : ('')) ?>>Žáci, žákyně (2009-2011)</option>
	<option value="6" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 6) ? ('selected="selected"') : ('')) ?>>Mladší žáci, žákyně (2006-2008)</option>
	<option value="7" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 7) ? ('selected="selected"') : ('')) ?>>Starší žáci, žákyně (2004-2005)</option>
...
<div class="form-group"> 
 ...
 <div class="checkbox">
    <label>
        <input type="checkbox" name="prohlaseni_zavodnika" class="required" /> Souhlasím s poskytnutím osobních údajů včetně dalších podmínek uvedených v předpisu závodu Bike Babí léto viz <a target="_blank" href="http://goodway.cz/cs/propozice">propozice</a><br /><br />
    </label>
</div>
