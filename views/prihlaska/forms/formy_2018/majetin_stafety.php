...
<div class="form-group">
    <input name="nazev_tymu" class="form-control required" placeholder="Název štafety" value="<?php echo (isset($udaje['nazev_tymu'])) ? ($udaje['nazev_tymu']) : ('') ?>" />
</div>
...
?>
    ...
    <div class="checkbox">
       <label>
           <input type="checkbox" name="prohlaseni_zavodnika" class="required" /> Souhlasíme s poskytnutím osobních údajů pro potřeby této registrace <br /><br />
       </label>
    </div>
    <div class="form-group"> 
