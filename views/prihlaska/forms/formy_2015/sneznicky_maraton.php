...
<div class="form-group"> 
	...
	<option value="1" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 1) ? ('selected="selected"') : ('')) ?>>40 km</option>
	<option value="2" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 2) ? ('selected="selected"') : ('')) ?>>20 km</option>
    </select>
</div>
...
<p>Odoslaním prihlášky a svojim podpisom potvrdzujem, že preteku sa zúčastňujem na vlastné nebezpečie za plnej cestnej premávky, budem rešpektovať pokyny usporiadateľov, dôkladne som sa oboznámil -a s podmienkami preteku, súhlasím s použitím mojich osobných údajov na potreby tohto preteku, online systému a súhlasím so zverejnením v rozsahu on-line prehľadov, štartovných a výsledkových listín v zmysle Zák. č. 428/2002 Zb.o ochrane osobných údajov. Súhlas je daný na dobu neurčitú a podľa § 20 odst. 3 cit. zákona je ho možné kedykoľvek odvolať. Súhlasím, aby moja e-mailová adresa bola použitá na marketingové účely týkajúce sa tohto podujatia a správcom Online prihlasovacieho systému. </p>
<div class="form-group"> 
