...
<div class="form-group"> 
	...
	<option value="1" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 1) ? ('selected="selected"') : ('')) ?>>Běžecký happening</option>
	<option value="2" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 2) ? ('selected="selected"') : ('')) ?>>Turistický happening</option>
    </select>
</div>
...
<div class="row">
	...
	<div class="form-group"> 
		...
		<option value="" selected>Tričko (+150Kč, nepovinné)</option>
