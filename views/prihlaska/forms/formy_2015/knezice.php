...
<div class="form-group"> 
	...
	<option value="1" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 1) ? ('selected="selected"') : ('')) ?>>Hlavní závody 10-50 km</option>
	<option value="2" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 2) ? ('selected="selected"') : ('')) ?>>Hobby MTB 25 km</option>
    </select>
</div>
...
<div class="form-group"> 
 ...
 <div class="checkbox">
    <label>
      <input type="checkbox" class="required" name="dalsi_udaje_2" value="" /> Souhlasím s prohlášením závodníka (<a style="text-decoration: underline" target="_blank" href="<?php echo URL ?>public/doc/prohlaseni-knezice-2015.pdf">Stáhnout</a>)
    </label>
</div>
