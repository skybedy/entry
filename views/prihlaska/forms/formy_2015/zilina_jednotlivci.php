...
<div class="row">
    ...
    <div class="col-lg-4">
	<div class="form-group"> 
	    <select name="ponozky" class="form-control placeholder required">
...
<div class="row">
	...
	<div class="form-group"> 
		...
		<option value="" selected>Tričko (+5€, nepovinné)</option>
...
<div class="form-group"> 
 ...
 <div class="checkbox">
    <label>
      <input type="checkbox" name="dalsi_udaje_2" value="DATATAG" /> Bezpečnostný system <a style="text-decoration: underline" target="_blank" href="http://datatag.co.uk/website-slovak">DATATAG</a> na bicykel SK alebo CZ  (30€, nepovinné)
    </label>
</div>
 <div class="checkbox">
    <label>
      <input type="checkbox" name="dalsi_udaje_3" value="Uterak" />  Uterák (ručník) - <a style="text-decoration: underline" target="_blank" href="http://www.bikepoint.sk/photos/obrazok_158.jpg">náhled</a> (17€, nepovinné)
    </label>
</div>
<div class="form-group"> 
