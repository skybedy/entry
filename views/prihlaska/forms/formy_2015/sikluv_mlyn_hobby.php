...
<div class="form-group">
	    ...
	    <label>Nejdříve si ve <a target="_blank" style="text-decoration: underline" href="<?php echo URL?>prihlaska/vypis-prihlasek">Výpisu přihlášek</a> zkontrolujte, zda je požadované stratovní číslo volné</label>
	    <input type="text" name="ids" class="form-control required" placeholder="Startovní číslo" value="<?php echo (isset($udaje['ids'])) ? ($udaje['ids']) : ('') ?>" />
