<?php
    ...
    $id_meny = 1;//€
    $typ_prihlasky = 1;
    // je tu zadáno pořadí podzavodu 1, ale jen proto, že tam něco musí být.. jinak je to společný formulář pro všecky a pořadí podzavodu nebude přesné, což v tomhle případě naai není třeba
    
?>
<input type="hidden" name="typ_prihlasky" value="<?php echo $typ_prihlasky ?>" />
<input type="hidden" name="id_meny" value="<?php echo $id_meny ?>" />
<input type="hidden" name="poradi_podzodu" value="1" />
...
<p>1) v případě, že se hlásíte na Triatlon Železný Prajzák a chcete tričko, zadejte jeho velikost, v případě, že tričko nechcete, zadejte volbu "Bez trička"<br />
	2) v případě, že se hlásíte na Dětský duatlon Železný Prajzáček, zadejte pouze volbu "Bez trička"</p>
