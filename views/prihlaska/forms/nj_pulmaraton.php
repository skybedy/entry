...
<div class="form-group">
    <input  type="text" name="dalsi_udaje_1" class="form-control" placeholder="Slevový kód" value="<?php echo (isset($udaje['dalsi_udaje_1'])) ? ($udaje['dalsi_udaje_1']) : ('') ?>" />
</div>
 <div class="checkbox">
    <label>
        <input type="checkbox" name="prohlaseni_zavodnika" class="required" /> Souhlasím s poskytnutím osobních údajů včetně dalších podmínek uvedených v předpisu závodu Novojičínský půlmaraton viz <a target="_blank" href="https://www.novojicinskypulmaraton.cz/propozice"><b>propozice</b></a><br /><br />
    </label>
</div>
