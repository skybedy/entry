...
<div class="form-group"> 
	...
	<option value="1" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 1) ? ('selected="selected"') : ('')) ?>>50km</option>
	<option value="2" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 2) ? ('selected="selected"') : ('')) ?>>20km (Hobby)</option>
    </select>
</div>
<div class="form-group">
...
<div class="row">
	...
	<div class="form-group"> 
		...
		<option value="" selected>Tričko / Shirt</option>
		<?php		
		    $tricka = Array();
		    $tricka['S-dámské'] = 'S-dámské';
		    $tricka['M-dámské'] = 'M-dámské';
		    $tricka['L-dámské'] = 'L-dámské';
		    $tricka['S-pánské'] = 'S-pánské';
		    $tricka['M-pánské'] = 'M-pánské';
		    $tricka['L-pánské'] = 'L-pánské';
		    $tricka['XL-pánské'] = 'XL-pánské';
		    $tricka['XXL-pánské'] = 'XXL-pánské';
