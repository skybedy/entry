...
<div class="form-group"> 
	...
	<option value="6" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 6) ? ('selected="selected"') : ('')) ?>>Dětský závod</option>
    </select>
</div>
...
<label class="checkbox-inline">
  <input type="checkbox" id="inlineCheckbox1" value="SKP" name="dalsi_udaje_1" <?php echo ((isset($udaje['dalsi_udaje_1']) && $udaje['dalsi_udaje_1'] == 'SKP') ? ' checked' : '') ?>  /> Zaškrtněte v případě, pokud se účastníte MR SKP ČR
</label>
</div>
