...
<div class="form-group"> 
	...
	<option value="" selected disabled>Vyberte závod / Select race</option>
	<option value="1" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 1) ? ('selected="selected"') : ('')) ?>>Elite (Účastníci Českého, Slovenského a Středoevropského  poháru v posledních 5 letech - 2011-2015)</option>
	<option value="2" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 2) ? ('selected="selected"') : ('')) ?>>Hobby</option>
    </select>
</div>
...
<div class="row">
	...
	<div class="form-group"> 
		...
		<option value="" selected disabled>Večeře / Dinner</option>
		<option value="1" <?php echo ((isset($udaje['pohlavi']) && $udaje['pohlavi'] == 'M') ? ('selected="selected"') : ('')) ?>>Hovězí guláš s chlebem</option>
		<option value="2" <?php echo ((isset($udaje['pohlavi']) && $udaje['pohlavi'] == 'Z') ? ('selected="selected"') : ('')) ?>>Rizoto s kuř. masem a zeleninou</option>
	    </select>
	</div>
    </div>
...
<div class="form-group"> 
    <input type="tel" name="telefon_1" class="form-control required" placeholder="Telefon v mezinárodním formátu  / Phone including country code (+420 XXX XXX XXX)" value="<?php echo (isset($udaje['telefon_1'])) ? ($udaje['telefon_1']) : ('') ?>" />
</div>
