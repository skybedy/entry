...
<div class="form-group"> 
	...
	<option value="1" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 1) ? ('selected="selected"') : ('')) ?>>Radegastova výzva - 13 km</option>
	<option value="2" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 2) ? ('selected="selected"') : ('')) ?>>Výstup na Radegasta pro kostní dřeň</option>
    </select>
</div>
...
<p>V případě, že chcete tričko, zadejte jeho velikost, v případě, že tričko nechcete, zadejte volbu "Bez trička"</p>
