...
<div class="form-group">
	...
	<option value="7" <?php echo ((isset($pocet_clenu) && $pocet_clenu == 7) ? ('selected="selected"') : ('')) ?>>7</option>
	<option value="8" <?php echo ((isset($pocet_clenu) && $pocet_clenu == 8) ? ('selected="selected"') : ('')) ?>>8</option>
    </select>
</div>
...
<div class="form-group">
	...
	$str .= '<option value="">Tričko (+250Kč, nepovinné)</option>';
	...
	$str .= '<label>';
        $str .= '<input type="checkbox" name="dalsi_udaje_2_'.$i.'" value="pojisteni" '.(isset($udaje['dalsi_udaje_2_'.$i]) ? 'checked' : '').' /> Pojištění České Pojišťovny, (+306Kč, nepovinné)';
        $str .= '</label>';
      	$str .= ' <span  class="glyphicon glyphicon-question-sign pojisteni_popover"  data-toggle="popover" title="Obecné informace o pojišťění" data-content="Doba nezbytného léčení DNL-D  200,- Kč. Trvalé následky úrazu 600 000,- Kč Smrt následkem úrazu 300 000,- Kč" aria-hidden="true"></span>';
        $str .= '</div>';
	$str .= '<br /><br />';
