...
<div class="form-group"> 
	...
	<option value="" selected disabled>Vyberte si délku závodu</option>
	<option value="1" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 1) ? ('selected="selected"') : ('')) ?>>4 km</option>
	<option value="2" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 2) ? ('selected="selected"') : ('')) ?>>8 km</option>
    </select>
</div>
<div class="checkbox">
    <label>
      <input type="checkbox" name="vmg" value="1" <?php echo (isset($udaje['open'])) ? ("checked") : ('') ?> /> Zašktnete v případě, jste-li zaměstnáni v rámci holdingu VMG
    </label>
</div>
...
<div class="form-group">
    <input  type="text" name="prislusnost" class="form-control required" placeholder="Oddíl nebo místo bydliště. Jste-li zaměstnáni u VMG, zadejte název společnosti" value="<?php echo (isset($udaje['prislusnost'])) ? ($udaje['prislusnost']) : ('') ?>" />
</div>
...
<div class="row">
	...
	<div class="form-group"> 
		...
		<option value="" selected>Tričko (+200Kč, nepovinné)</option>
