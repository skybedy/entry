...
<?php
    ...
    $tricka = Array();
    $tricka['4 roky'] = '4 roky';
    $tricka['6 let'] = '6 let';
    $tricka['8 let'] = '8 let';
    $tricka['10 let'] = '10 let';
    $tricka['12 let'] = '12 let';
    $tricka['S'] = 'S';
    $tricka['M'] = 'M';
    $tricka['L'] = 'L';
    $tricka['XL'] = 'XL';
...
<input type="hidden" name="id_kategorie" value="885" />
...
<div class="form-group">
	...
	$str .= '<option value="">Tričko (+120Kč, nepovinné)</option>';
