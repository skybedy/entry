...
<div class="row">
    <input type="hidden" name="id_kategorie" value="642" />
</div>
	...
	$str .= '<option value="">Tričko (+200Kč, nepovinné)</option>';
...
?>
   <div class="checkbox">
    <label>
      <input type="checkbox" class="required" name="dalsi_udaje_2" value="" /> Souhlasím s prohlášením závodníka (<a style="text-decoration: underline" target="_blank" href="<?php echo URL ?>public/doc/prohlaseni-kytlice-2016.pdf">Stáhnout</a>)
    </label>
    </div>
  <div class="form-group"> 
