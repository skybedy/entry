...
<div class="form-group">
 ...
 <input id="ids" type="text" name="ids" class="form-control  input-sm  required" placeholder="Startovní číslo" value="<?php echo (isset($udaje['ids'])) ? ($udaje['ids']) : ('') ?>" />
</div>
...
<div class="form-group"> 
  ...
  <select name="dalsi_udaje_1" class="form-control input-sm required placeholder">
...
<div class="form-group"> 
   <label>Značka motocyklu</label>
    <select name="dalsi_udaje_2" class="form-control input-sm required placeholder">
...
<div class="form-group"> 
   ...
   <select name="dalsi_udaje_3" class="form-control input-sm required placeholder">
...
<div class="form-group"> 
    ...
    <input id="znacka_prilby" name="dalsi_udaje_4" class="form-control input-sm" placeholder="Značka přilby (nepovinné)" value="<?php echo (isset($udaje['dalsi_udaje_4'])) ? ($udaje['dalsi_udaje_4']) : ('') ?>" />
</div>

<div class="form-group"> 
    <label for="homologace_prilby">Homologace přilby (nepovinné)</label>
    <input id="homologace_prilby" name="dalsi_udaje_5" class="form-control input-sm" placeholder="Homologace přilby (nepovinné)" value="<?php echo (isset($udaje['dalsi_udaje_5'])) ? ($udaje['dalsi_udaje_5']) : ('') ?>" />
</div>
...
<div class="form-group"> 
 ...
 <div class="checkbox">
    <label>
      <input type="checkbox" name="open" value="1" <?php echo (isset($udaje['open'])) ? ("checked") : ('') ?> /> Open (zašktnete pouze v případě, je-li vám více než 40 let a chcete startovat v kategorii Open)
    </label>
</div>
