...
<p>V případě, že budete absolvovat první triatlon v životě, zaškrtněte níže uvedené políčko.</p>


<div class="checkbox">
    <label>
      <input type="checkbox" name="dalsi_udaje_1" value="Prvni triatlon" /> První triatlon v životě 
    </label>
</div>
