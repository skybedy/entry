...
<div class="checkbox">
    <label>
        <input type="checkbox"  class="required" /> Účastníci musí dodržovat pravidla silničního provozu, zejména dodržovat jízdu při pravém okraji vozovky, v nepřehledných úsecích, zejména v zatáčkách. <b>Během akce jakožto i mimo ni nelze vjíždět mimo trasy určené pro akci časovka 3xTOP.cz Lysá hora!</b> <br /><br />
    </label>
</div>
<div class="checkbox">
    <label>
        <input type="checkbox" name="spac" /> Jsem členem asociace SPAC <br /><br />
    </label>
</div>
<div class="form-group"> 
