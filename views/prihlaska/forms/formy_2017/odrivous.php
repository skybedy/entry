...
<div class="form-group"> 
	...
	<option value="1" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 1) ? ('selected="selected"') : ('')) ?>>54 km</option>
	<option value="2" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 2) ? ('selected="selected"') : ('')) ?>>27 km</option>
	<option value="5" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 5) ? ('selected="selected"') : ('')) ?>>Dětský závod</option>
    </select>
</div>
...
<label class="checkbox-inline">
  <input type="checkbox" id="inlineCheckbox1" value="SKP" name="dalsi_udaje_1" <?php echo ((isset($udaje['dalsi_udaje_1']) && $udaje['dalsi_udaje_1'] == 'SKP') ? ' checked' : '') ?>  /> Zaškrtněte v případě, pokud se účastníte MR SKP ČR ( Jen členové klubu SKP )
</label>
</div>
