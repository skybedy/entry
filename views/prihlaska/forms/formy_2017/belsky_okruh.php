...
<div class="checkbox">
    <label>
        <input type="checkbox" name="elite" value="1" <?php echo (isset($udaje['open'])) ? ("checked") : ('') ?> /> Zašktnete v případě, chcete-li se přihlásit do kategorií ELITE, specifikace v <a target="_blank" style="text-decoration: underline" href="http://www.prajzska.eu/?page_id=447">propozicích</a>
    </label>
</div>
