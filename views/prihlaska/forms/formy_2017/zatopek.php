...
<label class="checkbox-inline">
  <input type="checkbox" id="inlineCheckbox1" value="Koprivnice" name="dalsi_udaje_1" <?php echo ((isset($udaje['dalsi_udaje_1']) && $udaje['dalsi_udaje_1'] == 'Koprivnice') ? ' checked' : '') ?>  /> Zaškrtněte v případě, máte-li trvalé bydliště v Kopřivnici
</label>
</div>
<div class="form-group"> 
<label class="checkbox-inline">
  <input type="checkbox" id="inlineCheckbox1" value="Roznov" name="dalsi_udaje_2" <?php echo ((isset($udaje['dalsi_udaje_1']) && $udaje['dalsi_udaje_1'] == 'Roznov') ? ' checked' : '') ?>  /> Zaškrtněte v případě, máte-li trvalé bydliště v Rožnově
</label>
</div>
