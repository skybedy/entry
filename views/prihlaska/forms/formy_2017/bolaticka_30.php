...
<div class="checkbox">
    <label>
        <input type="checkbox" name="elite" value="1" <?php echo (isset($udaje['open'])) ? ("checked") : ('') ?> /> Zašktnete v případě, chcete-li se přihlásit do kategorií ELITE, specifikace v <a target="_blank" style="text-decoration: underline" href="http://www.bolaticka30.cz/2017/propozice-zavodu">propozicích</a>
    </label>
</div>
...
<div class="row">
    ...
    <div class="col-lg-4">
	<div class="form-group"> 
	    <select name="tricko" class="form-control placeholder"  disabled="disabled>
...
<div class="form-group"> 
 ...
 <div class="checkbox">
    <label>
      <input type="checkbox" class="required" name="dalsi_udaje_2" value="" /> Potvrzuji, že jsem se seznámil s <a style="text-decoration: underline" target="_blank" href="http://www.bolaticka30.cz/2017/propozice-zavodu">propozicemi</a> a s ustanoveními zde uvedenými souhlasím.
    </label>
</div>
