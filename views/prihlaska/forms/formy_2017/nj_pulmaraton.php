...
<div class="form-group"> 
 ...
 <div class="checkbox">
    <label>
        <input type="checkbox" name="prohlaseni_zavodnika" class="required" /> Souhlasím s poskytnutím osobních údajů včetně dalších podmínek uvedených v předpisu závodu Novojičínský půlmaraton viz <a target="_blank" href="http://novojicinskypulmaraton.webnode.cz/"><b>propozice</b></a><br /><br />
    </label>
</div>
