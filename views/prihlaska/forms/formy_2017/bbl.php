...
<div class="form-group"> 
	...
	<option value="4" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 4) ? ('selected="selected"') : ('')) ?>>Děti (2011-2016)</option>
	<option value="5" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 5) ? ('selected="selected"') : ('')) ?>>Děti (2007-2010)</option>
	<option value="6" <?php echo ((isset($udaje['poradi_podzavodu']) && $udaje['poradi_podzavodu'] == 6) ? ('selected="selected"') : ('')) ?>>Děti (2003-2006)</option>
    </select>
</div>
...
<div class="row">
	...
	<!--	<option value="" selected>Tričko (nepovinné, +150Kč)</option>-->
