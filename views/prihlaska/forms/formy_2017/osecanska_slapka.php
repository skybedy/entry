...
<div class="checkbox">
    <label>
      <input type="checkbox" class="required" name="dalsi_udaje_2" value="" /> Souhlasím s prohlášením závodníka (<a style="text-decoration: underline" target="_blank" href="<?php echo URL ?>public/doc/prohlaseni-osecany-2017.pdf">Stáhnout</a>)
    </label>
</div>
<div class="form-group"> 
