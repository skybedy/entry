...
na +420 776131313.';
    ...
    public function MailZavodnikovi($mail){
       ...
       // $mail1->Subject = $this->NazevZavodu. ", predbezna registrace";
        ...
        if($this->IdZavodu == 6){//Cross Country Open
            ...
            $mail1->Body .= 'Olga Válková<br/>';
            $mail1->Body .= 'E-mail: <a href="pobyty@sikland.cz">pobyty@sikland.cz</a><br />';
            $mail1->Body .= '<hr />';
        }
       ...
       elseif($this->IdZavodu == 1){ // sikland winter
		...
		if($this->IdZavodu == 1){
			$this->id_kategorie = $this->udaje['id_kategorie']; //sikland winter race
	...
	private function Startovne(){
            if ($this->IdZavodu == 1) { //winter sikland race
	...
	public function VypisPrihlasek(){
	    //$this->Prevod();
	    $str = false;
	    if($this->IdZavodu == 6){ // cc licence
		$str .= $this->VypisPrihlasekEnduro();
	    }
	    elseif($this->IdZavodu == 9){ //cc hobby
