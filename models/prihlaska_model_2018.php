...
class Prihlaska_Model extends Model{
	...
	function __construct() {
		...
		foreach($data as $val){
		    ...
		    if($this->IdZavodu == 8 AND $this->RokZavodu == 2017){
                        $this->RokZavodu = 2018;
                    }
	...
	if($this->IdZavodu == 33 || $this->IdZavodu == 34 || $this->IdZavodu == 35 || $this->IdZavodu == 36 || $this->IdZavodu == 38){
	    $tp = $typ_prihlasky;
	}
	else{
...
na +420 776131313.';
	...
	(isset($this->udaje['poradi_podzavodu'])) ? ($vlozeni['poradi_podzavodu'] = $this->udaje['poradi_podzavodu']) : ('');
        ...
        if($this->IdZavodu != 47){ //hybrid BBL 2018
	...
	if($sth1->execute()){
		...
		for($i=1;$i<=$this->udaje['pocet_clenu'];$i++){
		    ...
		    (isset($this->udaje['dalsi_udaje_3_'.$i])) ? ($vlozeni['dalsi_udaje_3'] = $this->udaje['dalsi_udaje_3_'.$i]) : ('');
                    ...
                    if($this->IdZavodu == 69 && $this->RokZavodu == 2018){
    ...
    public function MailZavodnikovi($mail){
       ...
       // $mail1->Subject = $this->NazevZavodu. ", predbezna registrace";
        ...
        elseif($this->IdZavodu == 9){ //Perun
            ...
            $mail1->Body .= 'IBAN - '.$this->iban.' <br />';
            $mail1->Body .= 'Platba – SkyMarathon – 20 €<br />';
            $mail1->Body .= 'Variabilni symbol - '.$this->vs.'<br />';
            $mail1->Body .= 'Do zprávy pro příjemce vyplň – PERUN SKYMARATHON<br />';
            ...
            $mail1->Body .= 'Payment – SkyMarathon – 20 €<br />';
            ...
            $mail1->Body .= 'Those who have paid the entry payment till March 30, 2018 will be entitled to get a t-shirt.  Unfortunatelly it´s not posiible after this date because the concrete number of registered and paid T-shirts are going  to print !!! So  don´t forget about it. And again like last year Perun helps mothers with disabled children in association called NIKDY NEJSI SÁM  (you are never alone) so some part of your payment goes to their account. <br />';
            $mail1->Body .= 'looking forward on the start line of Perun 2018<br />';
        ...
        elseif($this->IdZavodu == 112){ //MAjetín
        ...
        elseif($this->IdZavodu == 46){//belsky_okruh
        ...
        elseif($this->IdZavodu == 110000 || $this->IdZavodu == 5 || $this->IdZavodu == 69){ 
            if($this->udaje['poradi_podzavodu'] == 1){
                $mail1->Body .= 'Dobrý den, děkujeme za přihlášku k závodu '.$this->NazevZavodu.'<br />';
                $mail1->Body .= '<hr />';
                $mail1->Body .= 'Vaše údaje jsou:<br />';
                ...
                $mail1->Body .= "Telefon: {$this->udaje['telefon_1']}<br />";
                $mail1->Body .= "Startovní vlna: {$this->udaje['dalsi_udaje_1']}<br />";
                if($this->udaje['tricko'] != 'bez'){
                    $mail1->Body .= "Tričko: {$this->udaje['tricko']}<br />";
                }
                $mail1->Body .= '<hr />';
                $mail1->Body .= 'Startovné prosím uhraďte nejpozději do 5 pracovních dnů jinak bude registrace neplatná. Platbu proveďte podle podle následujících údajů:<br />';
                $mail1->Body .= 'Číslo účtu: '.$this->cislo_uctu.'<br />';
                $mail1->Body .= 'Částka: '.$this->startovne_kc.' Kč<br />';
                $mail1->Body .= 'Variabilní symbol: '.$this->vs.'<br />';
                $mail1->Body .= 'Kontrolu vaši platby můžete provést ve Výpisu přihlášek  na <a href="http://entry.timechip.cz">entry.timechip.cz</a>';
                $mail1->Body .= '<hr />';
                $mail1->Body .= 'V připadě dotazů nás kontaktujte na níže uvedeném e-mailu<br />';
                $mail1->Body .= $this->poradatel.'<br />';
                $mail1->Body .= 'E-mail: <a href="mailto:'.$this->mail_na_poradatele.'">'.$this->mail_na_poradatele.'</a><br />';
                $mail1->Body .= ($this->telefon_na_poradatele == true) ? ('Tel: '.$this->telefon_na_poradatele) : ('');
                $mail1->Body .= '<hr />';
                //$mail1->AddAttachment('./public/doc/Winter_hei_run_souhlas_s_ucasti.pdf', $name = 'Souhlas_s_ucasti.pdf', $encoding = 'base64', $type = 'application/octet-stream');
                //$mail1->AddAttachment('./public/doc/Winter_hei_run_souhlas_zakonneho_zastupce.pdf', $name = 'Souhlas_zakonneho_zastupce.pdf', $encoding = 'base64', $type = 'application/octet-stream');
                //$mail1->AddAttachment('./public/doc/aktivity_race_souhlas_s_ucasti.pdf', $name = 'Souhlas_s_ucasti.pdf', $encoding = 'base64', $type = 'application/octet-stream');
                //$mail1->AddAttachment('./public/doc/aktivity_race_souhlas_zakonneho_zastupce.pdf', $name = 'Souhlas_zakonneho_zastupce.pdf', $encoding = 'base64', $type = 'application/octet-stream');
                $mail1->AddAttachment('./public/doc/hei_run_souhlas_s_ucasti.pdf', $name = 'Souhlas_s_ucasti.pdf', $encoding = 'base64', $type = 'application/octet-stream');
                $mail1->AddAttachment('./public/doc/hei_run_souhlas_zakonneho_zastupce.pdf', $name = 'Souhlas_zakonneho_zastupce.pdf', $encoding = 'base64', $type = 'application/octet-stream');
            }
            
            else{
                $mail1->Body .= 'Dobrý den, děkujeme za přihlášku k závodu '.$this->NazevZavodu.'<br />';
                $mail1->Body .= '<hr />';
                $mail1->Body .= 'Název týmu '.$this->udaje['nazev_tymu'].'<br />';
                $mail1->Body .= "Startovní vlna: {$this->udaje['tym_dalsi_udaje_3']}<br />";
                $mail1->Body .= '<hr />';
                $mail1->Body .= 'Startovné prosím uhraďte nejpozději do 5 pracovních dnů jinak bude registrace neplatná. Platbu proveďte podle podle následujících údajů:<br />';
                $mail1->Body .= 'Číslo účtu: '.$this->cislo_uctu.'<br />';
                $mail1->Body .= 'Částka: '.$this->startovne_kc.' Kč<br />';
                $mail1->Body .= 'Variabilní symbol: '.$this->vs.'<br />';
                $mail1->Body .= '<hr />';
                $mail1->Body .= 'Pokud budete chtít přidat nebo odebrat člena v týmu po vaši registraci nebo v případě jakýchkoliv dalších dotazů nás kontaktujte na níže uvedeném e-mailu<br />';
                $mail1->Body .= $this->poradatel.'<br />';
                $mail1->Body .= 'E-mail: <a href="mailto:'.$this->mail_na_poradatele.'">'.$this->mail_na_poradatele.'</a><br />';
                $mail1->Body .= ($this->telefon_na_poradatele == true) ? ('Tel: '.$this->telefon_na_poradatele) : ('');
                $mail1->Body .= '<hr />';
        ...
        elseif($this->IdZavodu == 26){ //bison mtb
            $mail1->Body .= 'Dobrý den, děkujeme za přihlášku k závodu '.$this->NazevZavodu.' '.YEAR.'.<br />';
            $mail1->Body .= '<hr />';
        ...
        elseif($this->IdZavodu == 18){//kuchyna
            //echo 'hoj';
            $mail1->Body .= 'Dobrý den, děkujeme za přihlášku k závodu '.$this->NazevZavodu.'.<br />';
            $mail1->Body .= '<hr />';
            $mail1->Body .= 'V případě, že budete chtít využít zvýhodněné startovné, je nutné do '.$this->konec_prihlasek.' realizovat platbu podle následujících údajů:<br />';
        ...
        elseif($this->IdZavodu == 50){//nachod
            //echo 'hoj';
            $mail1->Body .= 'Dobrý den, děkujeme za přihlášku k závodu '.$this->NazevZavodu.'.<br />';
            $mail1->Body .= '<hr />';
            $mail1->Body .= 'V případě, že budete chtít využít zvýhodněné startovné, je nutné do '.$this->konec_prihlasek.' realizovat platbu podle následujících údajů:<br />';
        ...
        elseif($this->IdZavodu == 21){//Pedalovnik
            //echo 'hoj';
            $mail1->Body .= 'Dobrý den, děkujeme za přihlášku k závodu '.$this->NazevZavodu.'.<br />';
            $mail1->Body .= '<hr />';
            if($this->udaje['poradi_podzavodu'] == 3){
        ...
        elseif($this->IdZavodu == 33 || $this->IdZavodu == 34 || $this->IdZavodu == 35 || $this->IdZavodu == 36 || $this->IdZavodu == 38){//Cross Country Open
            $mail1->Body .= 'Dobrý den, děkujeme za přihlášku k závodu '.$this->NazevZavodu.' '.YEAR.'.<br />';
            $mail1->Body .= '<hr />';
            $mail1->Body .= 'Vaše údaje jsou:<br />';
        ...
        elseif($this->IdZavodu == 78 || $this->IdZavodu == 80 || $this->IdZavodu == 92  || $this->IdZavodu == 96  || $this->IdZavodu == 125){//Cross Country Hobby
            $mail1->Body .= 'Dobrý den, děkujeme za přihlášku k závodu '.$this->NazevZavodu.' '.YEAR.'.<br />';
            $mail1->Body .= '<hr />';
            $mail1->Body .= 'Vaše údaje jsou:<br />';
            $mail1->Body .= "Jméno a příjmení: {$this->udaje['jmeno_1']} {$this->udaje['prijmeni_1']}<br />"; 
        ...
        elseif($this->IdZavodu == 47){//bbl
          if($this->udaje['poradi_podzavodu'] < 4){
              ...
              $mail1->Body .= "Telefon: {$this->udaje['telefon_1']}<br />";
              $mail1->Body .= '<hr />';
              $mail1->Body .= 'Pokud chcete využít zvýhodněné startovné (450Kč bez trička X 600Kč s tričkem a dárky) je třeba uhradit platbu nejpozději do 14. 8. 2018. Pakliže tak neučiníte, startovné na místě v den závodu čítá 600Kč (bez trička a dárků). Závodní dvojice (80km) hradí platbu výhradně dohromady z jednoho účtu. Poprosíme Vás platbu realizovat dle následujících údajů: <br />';
              $mail1->Body .= 'Číslo účtu: '.$this->cislo_uctu.'<br />';
              $mail1->Body .= 'Částka: '.$this->startovne_kc.' Kč<br />';
              $mail1->Body .= 'Variabilní symbol: '.$this->vs.'<br />';
              $mail1->Body .= '<hr />';
        ...
        elseif($this->udaje['poradi_podzavodu'] < 8 AND $this->udaje['poradi_podzavodu'] > 3){
              ...
              $mail1->Body .= "Telefon: {$this->udaje['telefon_1']}<br />";
              $mail1->Body .= '<hr />';
              $mail1->Body .= 'Pokud chcete využít předběžnou registraci, je nutné platbu uhradit do 14. 8. 2018 (100Kč). Na místě v den závodu dětské startovné čítá sice stejnou cenu, ovšem počet míst je omezen na 100 dětí. Registrovaní a zaplacení tak mají své místo předem jisté. Poprosíme Vás platbu realizovat dle následujících údajů: <br />';
              $mail1->Body .= 'Číslo účtu: '.$this->cislo_uctu.'<br />';
              $mail1->Body .= 'Částka: '.$this->startovne_kc.' Kč<br />';
              $mail1->Body .= 'Variabilní symbol: '.$this->vs.'<br />';
              $mail1->Body .= '<hr />';
            ...
            elseif($this->udaje['poradi_podzavodu'] == 9){
              ...
              $mail1->Body .= "Telefon: {$this->udaje['telefon_1']}<br />";
              $mail1->Body .= '<hr />';
              $mail1->Body .= 'Pokud chcete využít AKCI TRIČKO ZDARMA (450Kč= startovné + tričko) je třeba uhradit platbu nejpozději do 15.6. 2018. Od 16. 6. až do 14.8. 2018 čítá zvýhodněné startovné 450Kč (bez trička) a 600Kč (s tričkem a dárky). Závodní dvojice (80km) hradí platbu výhradně dohromady z jednoho účtu. Poprosíme Vás platbu realizovat dle následujících údajů: <br />';
              $mail1->Body .= 'Číslo účtu: '.$this->cislo_uctu.'<br />';
              $mail1->Body .= 'Částka: '.$this->startovne_kc.' Kč<br />';
              $mail1->Body .= 'Variabilní symbol: '.$this->vs.'<br />';
              $mail1->Body .= '<hr />';
	    ...
	    isset($this->udaje['pohlavi_1']) ? $pohlavi = $this->udaje['pohlavi_1'] : ''; 
            ...
            elseif($this->IdZavodu == 11 || $this->IdZavodu == 5 || $this->IdZavodu == 69){
            ...
            elseif($this->IdZavodu == 112){ //majetin
		switch($this->udaje['poradi_podzavodu']){
            ...
            elseif($this->IdZavodu == 18  || $this->IdZavodu == 50){ //24 hod kuchyna, nachod
		switch($this->udaje['poradi_podzavodu']){
		    case 1:
		...
		switch($this->udaje['poradi_podzavodu']){
            ...
            elseif($this->IdZavodu == 26){
                if($this->udaje['poradi_podzavodu'] == 4){
                    $this->VyberKategoriePodleId(524);
                }
                else{
                    $this->VyberKategorieDefault($this->udaje['poradi_podzavodu']);
                }
            ...
            elseif($this->IdZavodu == 78 || $this->IdZavodu == 80 || $this->IdZavodu == 92  || $this->IdZavodu == 96  || $this->IdZavodu == 125){ //cc hobby
		if(!isset($this->udaje['open'])){
		    $this->VyberKategorieDefault($this->udaje['poradi_podzavodu']);
		}
		else{
            ...
            elseif($this->IdZavodu == 47){ //bbl
                ...
                elseif($this->udaje['poradi_podzavodu'] == 9){
                    ...
                    $this->VyberKategoriePodleId(694);
                }
	    }
	...
	private function Startovne(){
            if ($this->IdZavodu == 7) {
                ...
                if($this->udaje['id_kategorie'] == 301){
                    $this->vychozi_startovne = 2800 * $pocet_clenu;
                }
                $this->startovne_kc = $this->vychozi_startovne;
            }
            
            elseif($this->IdZavodu == 118){ //osecanska slapka
                 $vek =  date('Y') - $this->udaje['rok_narozeni'];
                if($this->udaje['poradi_podzavodu'] == 1){
		...
		$this->startovne_kc = $this->vychozi_startovne;
            ...
            elseif ($this->IdZavodu == 11 || $this->IdZavodu == 5) {
                if($this->udaje['poradi_podzavodu'] == 1){
                    if($this->udaje['tricko'] != 'bez'){
                        $this->vychozi_startovne = $this->vychozi_startovne + 250;
                    }
                }
                else{
            ...
            elseif ($this->IdZavodu == 69) {
                if($this->udaje['poradi_podzavodu'] == 1){
                    ...
                    if(isset($this->udaje['dalsi_udaje_2'])){
                        $this->vychozi_startovne = $this->vychozi_startovne + 100;
                    }
		...
		elseif($this->udaje['poradi_podzavodu'] == 4){
		    $this->vychozi_startovne = $this->startovne_z_db_kc - 400;
		    $this->startovne_kc = $this->vychozi_startovne; //mail
		}
	    }
            ...
            elseif($this->IdZavodu == 20){ //bystrice alis run
                if($this->udaje['poradi_podzavodu'] > 2){
                    $this->vychozi_startovne = 100;
                }
                $this->startovne_kc = $this->vychozi_startovne;
            ...
            elseif($this->IdZavodu == 26){
                ...
                /*
                if(isset($this->udaje['ostatni_udaje_1'])){
                    if($this->udaje['ostatni_udaje_1'] == 15){
                        $this->vychozi_startovne = 15;
                    }
                }
                */
            ...
            elseif($this->IdZavodu == 30){ //hlucin
                if($this->udaje['poradi_podzavodu'] == 2){
                    $this->vychozi_startovne = 140;
                }
                $this->startovne_kc = $this->vychozi_startovne;
            }
            
            elseif($this->IdZavodu == 46){ //belsky okruh
		if($this->udaje['poradi_podzavodu'] == 1){
	...
	public function Radkovani1($i){
        ...
        public function Vlny(){
            ...
            /*
            for($i=1;$i<=15;$i++){
                $sql1 .= 'SUM(dalsi_udaje_1=\''.$i.'\') AS vlna_'.$i.',';
            } */       
           ...
           /* $sql1 .=  "SUM(dalsi_udaje_1='9:30') AS vlna_1,"
                    . "SUM(dalsi_udaje_1='9:45') AS vlna_2,"
                    . "SUM(dalsi_udaje_1='10:00') AS vlna_3,"
                    . "SUM(dalsi_udaje_1='10:15') AS vlna_4,"
                    . "SUM(dalsi_udaje_1='10:30') AS vlna_5,"
                    . "SUM(dalsi_udaje_1='10:45') AS vlna_6,"
                    . "SUM(dalsi_udaje_1='11:00') AS vlna_7,"
                    . "SUM(dalsi_udaje_1='11:15') AS vlna_8,"
                    . "SUM(dalsi_udaje_1='11:30') AS vlna_9,"
                    . "SUM(dalsi_udaje_1='11:45') AS vlna_10,"
                    . "SUM(dalsi_udaje_1='12:00') AS vlna_11,"
                    . "SUM(dalsi_udaje_1='12:15') AS vlna_12,"
                    . "SUM(dalsi_udaje_1='12:30') AS vlna_13,"
                    . "SUM(dalsi_udaje_1='12:45') AS vlna_14,"
                    . "SUM(dalsi_udaje_1='13:00') AS vlna_15 "; */
            
            
                        
            $sql1 .=  "SUM(dalsi_udaje_1='10:00') AS vlna_1,"  //co 20 minut, posledni ve 13
                    . "SUM(dalsi_udaje_1='10:20') AS vlna_2,"
                    . "SUM(dalsi_udaje_1='10:40') AS vlna_3,"
                    . "SUM(dalsi_udaje_1='11:00') AS vlna_4,"
                    . "SUM(dalsi_udaje_1='11:20') AS vlna_5,"
                    . "SUM(dalsi_udaje_1='11:40') AS vlna_6,"
                    . "SUM(dalsi_udaje_1='12:00') AS vlna_7,"
                    . "SUM(dalsi_udaje_1='12:20') AS vlna_8,"
                    . "SUM(dalsi_udaje_1='12:40') AS vlna_9,"
                    . "SUM(dalsi_udaje_1='13:00') AS vlna_10 ";
            
            
            
            
            //$sql1 .= "100 "; //umela stovka aby se z cyklu nemusela odstrabnovat posledni carka        
           // $sql1 .=  "FROM prihlasky_jednotlivci_2018 WHERE id_zavodu = 11";
            //$sql1 .=  "FROM prihlasky_jednotlivci_2018 WHERE id_zavodu = 5";
            $sql1 .=  "FROM prihlasky_jednotlivci_2018 WHERE id_zavodu = 69";
            $sth1 = $this->db->prepare($sql1);
            $sth1->execute();
