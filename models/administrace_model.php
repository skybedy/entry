...
class Administrace_Model extends Model{
	...
	public function Index(){
		...
		while($dbdata1 = $sth1->fetchObject()){
		    ...
		    if($dbdata1->typ_zavodnika == 2 || $dbdata1->typ_zavodnika == 3 || $dbdata1->typ_zavodnika == 6 ){
	...
	public function ZmenaUdaju(){
		...
		if(isset($_POST['delete'])){
		    ...
		    $sth2->execute();
                    ...
                    $sql = "UPDATE $this->sqlprihlaskyjednotlivci SET telefon_1 = '{$_POST['telefon_1']}', zaplaceno = '{$_POST['platba']}',mail = '{$_POST['mail']}',prislusnost = '{$_POST['prislusnost']}',prijmeni_1 = '{$_POST['prijmeni_1']}',jmeno_1 = '{$_POST['jmeno_1']}',startovne = '{$_POST['startovne']}',tricko = '{$_POST['tricko']}',id_kategorie = '$id_kategorie',poradi_podzavodu = '$poradi_podzavodu',poznamka_poradatele = '{$_POST['poznamka_poradatele']}' WHERE id_prihlasky = '{$_POST['id_prihlasky']}'";
	...
	public function ZmenaUdajuTymuJednotlivce(){
        ...
        public function ExportExcelJednotlivciZal(){
	     require "./libs/phpexcel/Classes/PHPExcel.php";
